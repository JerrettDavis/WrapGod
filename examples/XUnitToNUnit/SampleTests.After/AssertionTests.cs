...
{
    // Scenario 15: Assert.That + Is.EqualTo / Is.Not.EqualTo (was Assert.Equal / Assert.NotEqual)
    [Test]
    ...
    // Scenario 16: Assert.That + Is.True / Is.False (was Assert.True / Assert.False)
    [Test]
    ...
    // Scenario 17: Assert.That + Is.Null / Is.Not.Null (was Assert.Null / Assert.NotNull)
    [Test]
    ...
    // Scenario 18: Assert.Throws<T> (same API, different namespace)
    [Test]
    ...
    // Scenario 23: Assert.That + Is.InstanceOf<T> / Is.AssignableFrom<T>
    [Test]
    ...
    // Scenario 24: Assert.That + Is.InRange (was Assert.InRange)
    [Test]
    ...
    // Scenario 25: Multiple assertions on collection elements (was Assert.Collection)
    [Test]
    ...
    // Scenario 26: Assert.That + Has.All (was Assert.All)
    [Test]
    ...
    // Scenario 27: Assert.That + Has.Count.EqualTo(1) (was Assert.Single)
    [Test]
