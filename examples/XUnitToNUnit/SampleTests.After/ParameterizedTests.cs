...
{
    // Scenario 5: [TestCase] (was [Theory] + [InlineData])
    [TestCase(1, 2, 3)]
    [TestCase(-1, -2, -3)]
    [TestCase(0, 0, 0)]
    ...
    // Scenario 6: [TestCase] with strings (was [Theory] + [InlineData])
    ...
    // Scenario 7: [TestCaseSource] with static method (was [MemberData])
    ...
    // Scenario 8: [TestCaseSource] with static property (was [MemberData] property)
    ...
    // Scenario 9: [TestCaseSource] with class (was [ClassData])
