...
public class ParameterizedTests
{
    ...
    // Scenario 6: [Theory] + [InlineData] with strings
    [Theory]
    ...
    // Scenario 7: [Theory] + [MemberData] with static method
    [Theory]
    ...
    // Scenario 8: [Theory] + [MemberData] with static property
    [Theory]
