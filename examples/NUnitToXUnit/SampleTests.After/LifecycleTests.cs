...
// Scenario 10 & 11: Constructor / IDisposable (was [SetUp] / [TearDown])
public class LifecycleTests : IDisposable
{
    ...
    {
        // Runs before every test (was [SetUp])
        _log = [];
    }
    ...
    public void Dispose()
    {
        // Runs after every test (was [TearDown])
        _log.Clear();
    }
}

// Scenario 12: IClassFixture<T> (was [OneTimeSetUp] / [OneTimeTearDown])
...
// Scenario 13: ITestOutputHelper (was TestContext.Out)
...
// Scenario 14: Collection fixture (was [SetUpFixture])
