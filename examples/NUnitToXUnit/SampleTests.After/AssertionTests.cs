...
{
    // Scenario 15: Assert.Equal / Assert.NotEqual (was Assert.That + Is.EqualTo)
    [Fact]
    ...
    // Scenario 16: Assert.True / Assert.False (was Assert.That + Is.True / Is.False)
    [Fact]
    ...
    // Scenario 17: Assert.Null / Assert.NotNull (was Assert.That + Is.Null)
    [Fact]
    ...
    // Scenario 25: Assert.Collection (was individual element assertions)
    [Fact]
    ...
    // Scenario 26: Assert.All (was Has.All.Matches)
    [Fact]
    ...
    // Scenario 27: Assert.Single (was Has.Count.EqualTo(1))
    [Fact]
